...
var TodoApp = function () {
	...
	_createClass(TodoApp, [{
		...
		value: function render() {
			...
			var allTodos = todoApp.getByStatus();
			...
			(0, _diffhtml.innerHTML)(this.mount, (0, _diffhtml.html)(_templateObject, this.onSubmitHandler.bind(this), this.onClickHandler.bind(this), this.handleKeyDown.bind(this), this.startEditing.bind(this), this.toggleCompletion.bind(this), allTodos.length ? (0, _diffhtml.html)(_templateObject2, this.setCheckedState(), _todoList2.default.call(this, {
				...
				todos: todos
			}), activeTodos.length, activeTodos.length == 1 ? 'item' : 'items', this.getNavClass('/'), this.getNavClass('/active'), this.getNavClass('/completed')) : '', this.existingMarkup));
		}
	}]);
...
},{"./components/todo-app":2,"./util/diffhtml":10}],5:[function(_dereq_,module,exports){
'use strict';
...
},{"./reducers/todo-app":7,"./reducers/url":8,"redux":17,"redux-logger":11}],10:[function(_dereq_,module,exports){
'use strict';
...
},{"diffhtml":1}],11:[function(_dereq_,module,exports){
"use strict";
...
},{"./compose":15}],13:[function(_dereq_,module,exports){
'use strict';
...
},{"./createStore":16,"./utils/warning":18,"lodash/isPlainObject":22}],15:[function(_dereq_,module,exports){
"use strict";
...
},{"lodash/isPlainObject":22}],17:[function(_dereq_,module,exports){
'use strict';
...
},{"./applyMiddleware":12,"./bindActionCreators":13,"./combineReducers":14,"./compose":15,"./createStore":16,"./utils/warning":18}],18:[function(_dereq_,module,exports){
'use strict';
...
},{"./_getPrototype":19,"./_isHostObject":20,"./isObjectLike":21}]},{},[4]);
