...
var TodoApp = function () {
	...
	_createClass(TodoApp, [{
		...
		value: function animateDetached(el) {
			...
			if (el.matches('.todo-list li')) {
				return new Promise(function (resolve) {
					return el.animate([{ opacity: 1, transform: 'scale(1)' }, { opacity: 0, transform: 'scale(.5)' }], { duration: 250 }).onfinish = resolve;
				}).then(null, warnAboutWebAnim);
			}
		}
	}, {
		...
		value: function render() {
			...
			var encode = TodoApp.encode;

			localStorage['diffhtml-todos'] = JSON.stringify(todos);

			this.diffInnerHTML = (0, _diffhtml.html)(_templateObject, this.onSubmitHandler.bind(this), this.onClickHandler.bind(this), this.handleKeyDown.bind(this), this.stopEditing.bind(this), this.startEditing.bind(this), this.toggleCompletion.bind(this), todos.length ? (0, _diffhtml.html)(_templateObject2, this.setCheckedState(), _todoList2.default.call(this, { todos: todos }), todoApp.getRemaining().length, todoApp.getRemaining().length == 1 ? 'item' : 'items') : '', this.existingMarkup);
		}
	}]);
...
},{"../redux/actions/todo-app":5,"../redux/store":7,"./todo-list":3,"diffhtml":1}],3:[function(_dereq_,module,exports){
'use strict';
...
var _templateObject = _taggedTemplateLiteral(['\n\t\t<li key="', '" class="', '">\n\t\t\t<div class="view">\n\t\t\t\t<input class="toggle" type="checkbox" ', '>\n\t\t\t\t<label>', '</label>\n\t\t\t\t<button class="destroy"></button>\n\t\t\t</div>\n\n\t\t\t<form class="edit-todo">\n\t\t\t\t<input value="', '" class="edit">\n\t\t\t</form>\n\t\t</li>\n\t'], ['\n\t\t<li key="', '" class="', '">\n\t\t\t<div class="view">\n\t\t\t\t<input class="toggle" type="checkbox" ', '>\n\t\t\t\t<label>', '</label>\n\t\t\t\t<button class="destroy"></button>\n\t\t\t</div>\n\n\t\t\t<form class="edit-todo">\n\t\t\t\t<input value="', '" class="edit">\n\t\t\t</form>\n\t\t</li>\n\t']);

exports.default = function (props) {
	var _this = this;

	return props.todos.map(function (todo) {
		return html(_templateObject, todo.key, _this.getTodoClassNames(todo), todo.completed ? 'checked' : '', encode(todo.title), encode(todo.title));
	});
};
...
},{"./components/todo-app":2,"./util/diffhtml":8}],5:[function(_dereq_,module,exports){
'use strict';
...
},{"../actions/todo-app":5}],7:[function(_dereq_,module,exports){
'use strict';
...
},{"./reducers/todo-app":6,"redux":15,"redux-logger":9}],8:[function(_dereq_,module,exports){
'use strict';
...
},{"diffhtml":1}],9:[function(_dereq_,module,exports){
"use strict";
...
},{"./createStore":14,"./utils/warning":16,"lodash/isPlainObject":20}],13:[function(_dereq_,module,exports){
"use strict";
...
},{"lodash/isPlainObject":20}],15:[function(_dereq_,module,exports){
'use strict';
...
},{"./_getPrototype":17,"./_isHostObject":18,"./isObjectLike":19}]},{},[4]);
